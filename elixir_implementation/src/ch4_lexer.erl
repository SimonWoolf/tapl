-file("/home/simon/.asdf/installs/erlang/18.3/lib/erlang/lib/parsetools-2.1.1/include/leexinc.hrl", 0).
...
-file("src/ch4_lexer.xrl", 13).

-file("/home/simon/.asdf/installs/erlang/18.3/lib/erlang/lib/parsetools-2.1.1/include/leexinc.hrl", 14).
...
yystate(3, [10|Ics], Line, Tlen, _, _) ->
    yystate(3, Ics, Line+1, Tlen+1, 1, Tlen);
...
-file("src/ch4_lexer.xrl", 7).
yyaction_0(TokenChars, TokenLine) ->
     { token, { list_to_atom (TokenChars), TokenLine } } .

-compile({inline,yyaction_1/0}).
-file("src/ch4_lexer.xrl", 8).
yyaction_1() ->
     skip_token .

-compile({inline,yyaction_2/0}).
-file("src/ch4_lexer.xrl", 9).
yyaction_2() ->
     skip_token .

-file("/home/simon/.asdf/installs/erlang/18.3/lib/erlang/lib/parsetools-2.1.1/include/leexinc.hrl", 290).
