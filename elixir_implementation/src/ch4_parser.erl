...
-file("src/ch4_parser.yrl", 13).

-file("/home/simon/.asdf/installs/erlang/18.3/lib/erlang/lib/parsetools-2.1.1/include/yeccpre.hrl", 0).
%%
%% %CopyrightBegin%
%%
...
yeccpars2_0(S, '0', Ss, Stack, T, Ts, Tzr) ->
...
yeccpars2_0(S, pred, Ss, Stack, T, Ts, Tzr) ->
 yeccpars1(S, 6, Ss, Stack, T, Ts, Tzr);
yeccpars2_0(S, succ, Ss, Stack, T, Ts, Tzr) ->
...
yeccpars2_12(S, then, Ss, Stack, T, Ts, Tzr) ->
...
yeccpars2_14(S, else, Ss, Stack, T, Ts, Tzr) ->
...
yeccgoto_term(4, Cat, Ss, Stack, T, Ts, Tzr) ->
...
-file("src/ch4_parser.yrl", 3).
yeccpars2_16_(__Stack0) ->
 [__6,__5,__4,__3,__2,__1 | __Stack] = __Stack0,
 [begin
   { 'if' , __2 , then , __4 , else , __6 }
  end | __Stack].


-file("src/ch4_parser.yrl", 14).
